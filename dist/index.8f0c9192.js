...
})({"41Jgy":[function(require,module,exports) {
module.exports = require("./helpers/browser/js-loader")(require('./helpers/bundle-url').getBundleURL('70wk8') + "bootstrap.e460467a.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root('9AxfY')
);
...
},{}]},[], null, "parcelRequire08f4")
parcelRequire08f4("41Jgy");
